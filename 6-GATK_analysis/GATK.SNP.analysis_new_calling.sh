...
REFERENCE="/gpfs/fs2/scratch/alarracu_lab/centromere_population_genomics/mcc_run_dir/reference/dmel_scaffold2_plus0310_2.fasta"
...
GATK GenomicsDBImport \
       ...
       --sample-name-map DGRP.test.vcf.list \
       --reader-threads 24 \
       -L intervals.select.list
...
#    --resource:DGRP,known=false,training=true,truth=true,prior=15.0 /home/cchang45/GenomeAnalysisTK-3.7/dgrp2_dm6_siteonly.vcf \
#    --resource:DPGP,known=false,training=true,truth=true,prior=15.0 /home/cchang45/GenomeAnalysisTK-3.7/Drosophila_melanogaster.vcf \
...
# module load java
# /home/cchang45/gatk-4.1.2.0/gatk  VariantFiltration \
# -R $REFERENCE \
# -V All_SNPs.vcf.gz \
